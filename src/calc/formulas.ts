 ...
 * Legacy 5-criterion weights for the old 0-100 priority scoring system.
 */
...
/**
 * @deprecated Use NEW_PRIORITY_TIERS instead.
 * Legacy tier thresholds using 80/60/40 cutoffs on the old 0-100 scale.
 */
...
/**
 * @deprecated Use calculateNewPriorityScore() instead.
 * Legacy 5-criterion priority scoring on 0-100 scale.
 *
 * WEIGHTS:
 ...
 * Legacy tier assignment using 80/60/40 thresholds on the old 0-100 scale.
 */
 ...
 * Legacy phase assignment using 80/60/40 thresholds on the old 0-100 scale.
 */
