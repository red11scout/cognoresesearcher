...
export async function generateWhatIfSuggestion(
  ...
  const stepDescriptions: Record<number, string> = {
    ...
    4: "AI Use Case Generation - Generate AI use case records with ID, Function, Sub-Function, Use Case Name, Description, AI Primitives, Target Friction, Primary Pattern (Reflection/Tool Use/Planning/ReAct Loop/Prompt Chaining/Semantic Router/Constitutional Guardrail/Orchestrator-Workers/Agent Handoff/Parallelization/Generator-Critic/Group Chat), Alternative Pattern, Pattern Rationale, and EPOCH Flags",
