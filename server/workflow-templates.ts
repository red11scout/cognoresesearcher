...
export const USE_CASE_TEMPLATES: UseCaseWorkflowTemplate[] = [
  ...
  },
  {
    ...
    agenticPattern: "Generator-Critic",
    patternRationale: "Generator-Critic pattern excels at document intelligence, with one agent extracting data while another validates accuracy. This dual-agent approach ensures high-quality extraction from complex medical and financial documents.",
    currentStateWorkflow: [
      {
        stepNumber: 1,
        stepId: "CS-01",
  ...
  },
  {
    ...
    patternRationale: "Reflection pattern excels at personalized learning experiences, self-critiquing recommendations and adapting content and pacing to individual rep backgrounds, learning styles, and progress. It creates tailored onboarding paths that accelerate time-to-productivity.",
    currentStateWorkflow: [
      {
        stepNumber: 1,
        stepId: "CS-01",
  ...
  },
  {
    ...
    agenticPattern: "Reflection",
    patternRationale: "Reflection pattern learns from each client interaction to personalize product recommendations. It self-critiques initial suggestions and builds individual preference profiles to optimize cross-sell success rates.",
    currentStateWorkflow: [
      {
        stepNumber: 1,
        stepId: "CS-01",
